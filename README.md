...
2. Download the font files from the [repo's font directory](https://github.com/stanlrt/typst-zhaw-thesis/tree/main/fonts)
...
2. Download the font files from this repo's font directory and make them accessible to the compiler (https://typst.app/docs/reference/text/text/#parameters-font)
